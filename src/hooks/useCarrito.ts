...
const useCarrito = () => {
    ...
    const iniciarCarrito = () : Guitar[] =>{
      ...
      function agregarAlCarrito(productos : Guitar) {
        // funcion de flecha
